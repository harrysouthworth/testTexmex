...
# {.tabset}
<div class="watermark">DRAFT <span style='color:white; font-size:xx-small;'>`r gitcv()`</span></div>
```{r, echo=FALSE, results = "asis"}
printcv()
```

## Introduction
The texmex [@texmex], margarita [@margarita] and lmr [@lmr] packages have
testing suites that rely on
...
for (i in 1:length(testFiles)){
  cat(paste0("\n############## ", i, " ", testFiles[i], " ##############\n"))
  run_test_file(here(testFiles[i]))
}
dev.off()
```
