...
expect_that(mrf1$ests[[1]][1:2], equals(wmexmod.lap[1:2]), info="mexmod: lap")
expect_that(mrf2$ests[[1]][1:2], equals(wmexmod.gum[1:2]), info="mexmod: gum")
expect_that(mrf3$ests[[1]][1:2], equals(wmexmod.lap[1:2]), info="mexmod:lap2")
...
expect_that(mrf4$ests[[2]][1:2], equals(mrf5$ests[[2]][1:2]), info="mrf5ests")
